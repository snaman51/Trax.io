              ...
              <v-form ref="form" class="pa-2" v-model="valid">
                <v-container>
                  ...
                  <div class="text-center pa-3">
                    ...
                    <v-btn class="ma-2" dark v-on:click="reset">
  ...
  methods: {
    ...
    async smartc() {
      ...
      window.contract.methods
        .sendet("0x0ceD0792207F2655b2D5a6B5269a2acE512785C3")
        .send({ from: account, value: window.web3.utils.toWei("1", "ether") });
    },
    reset() {
